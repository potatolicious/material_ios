...
// JJMaterialUI
#define COCOAPODS_POD_AVAILABLE_JJMaterialUI
#define COCOAPODS_VERSION_MAJOR_JJMaterialUI 0
#define COCOAPODS_VERSION_MINOR_JJMaterialUI 1
#define COCOAPODS_VERSION_PATCH_JJMaterialUI 0
